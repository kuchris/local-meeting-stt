...
uv run --with soundcard --with soundfile --with numpy --with soxr --with requests python -u live_cpp.py --server --save-recording --session-prefix cpp_openvino_gpu_live --whisper-server bin_openvino\Release\whisper-server.exe --model models\ggml-small.bin --threads 8 --openvino-device GPU --beam-size 1 --best-of 1 --no-fallback --chunk-seconds 3 --max-backlog 1 --gain 2.0 %*
