...
uv run --with soundcard --with soundfile --with numpy --with soxr --with requests --with faster-whisper python -u live_cpp.py --server --streaming --save-recording --session-prefix cpp_openvino_gpu_live --whisper-server bin_openvino\Release\whisper-server.exe --model models\ggml-small.bin --threads 8 --openvino-device GPU --beam-size 1 --best-of 1 --no-fallback --chunk-seconds 3 --max-backlog 1 %*
